    ...
    <main className="flex-1 bg-slate-950 py-24 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          <span className="text-xs font-bold text-blue-500 uppercase tracking-widest block font-bold">Potencia tu negocio</span>
          <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight">Diseñado para vender de forma simple</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
          {/* Feature 1 */}
          <div className="p-8 bg-slate-900/50 border border-slate-800/80 hover:border-blue-500/40 rounded-3xl space-y-4 transition-all duration-300 shadow-md group">
            ...
            <h3 className="font-bold text-white text-lg">Onboarding en 30s</h3>
          ...
          {/* Feature 2 */}
          <div className="p-8 bg-slate-900/50 border border-slate-800/80 hover:border-blue-500/40 rounded-3xl space-y-4 transition-all duration-300 shadow-md group">
            <div className="w-12 h-12 rounded-2xl bg-red-500/10 text-red-400 flex items-center justify-center group-hover:scale-110 transition-transform">
              <MessageSquare className="w-6 h-6" />
            </div>
            <h3 className="font-bold text-white text-lg">Cierre por WhatsApp</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-medium">
          ...
          <div className="p-8 bg-slate-900/50 border border-slate-800/80 hover:border-blue-500/40 rounded-3xl space-y-4 transition-all duration-300 shadow-md group">
            ...
            <h3 className="font-bold text-white text-lg">Control de Pedidos</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-medium">
          ...
          <div className="p-8 bg-slate-900/50 border border-slate-800/80 hover:border-blue-500/40 rounded-3xl space-y-4 transition-all duration-300 shadow-md group">
            ...
            <h3 className="font-bold text-white text-lg">Optimización de Fotos</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-medium">
