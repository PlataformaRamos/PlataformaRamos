...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  return (
    <main className="flex-1 flex flex-col justify-center items-center bg-white text-slate-900">
      ...
      <section className="relative w-full max-w-7xl mx-auto px-6 py-20 lg:py-28 flex flex-col lg:flex-row items-center gap-12 lg:gap-8 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-500/5 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute top-1/3 right-1/4 translate-x-1/2 w-[400px] h-[400px] bg-red-500/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="flex-grow flex-shrink-0 space-y-6 lg:max-w-2xl text-center lg:text-left z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[64px] font-black tracking-tight leading-[1.05] text-slate-900">
        ...
        <div className="flex-1 w-full max-w-md lg:max-w-none relative flex justify-center z-10">
          ...
          <div className="relative w-full max-w-[320px] aspect-[9/18] rounded-[44px] border-[8px] border-slate-900 bg-slate-950 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] overflow-hidden flex flex-col group transition-all duration-500 hover:scale-[1.02] hover:-rotate-1">
            {/* Isla del teléfono */}
          ...
          <div className="absolute top-12 -right-6 bg-white border border-slate-100 p-3.5 rounded-2xl shadow-2xl flex items-center gap-3 backdrop-blur max-w-[210px] hover:scale-105 transition-transform duration-300">
            ...
            <div className="min-w-0">
              <div className="text-[10px] font-extrabold text-slate-900">Nuevo Pedido</div>
              <div className="text-[9px] text-slate-500 truncate">Enviado por Kenneth</div>
            </div>
          </div>
        </div>
      </section>
