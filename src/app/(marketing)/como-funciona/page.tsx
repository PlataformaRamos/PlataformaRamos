...
export default function ComoFuncionaPage() {
  return (
    <main className="flex-1 bg-slate-950 py-24 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 translate-x-1/2 w-[400px] h-[400px] bg-red-600/5 rounded-full blur-[120px] pointer-events-none" />

      <div className="w-full max-w-5xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto space-y-4 mb-20">
          <span className="text-xs font-bold text-blue-500 uppercase tracking-widest block font-bold">Flujo simple</span>
          <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight">Vende en 3 sencillos pasos</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          <div className="space-y-4 text-center md:text-left relative group">
            <div className="text-[72px] font-black text-slate-900 group-hover:text-blue-600/35 transition-colors select-none leading-none">01</div>
            <h3 className="text-xl font-bold text-white">Sube tus productos</h3>
          ...
          {/* Paso 2 */}
          <div className="space-y-4 text-center md:text-left relative group">
            <div className="text-[72px] font-black text-slate-900 group-hover:text-blue-600/35 transition-colors select-none leading-none">02</div>
            <h3 className="text-xl font-bold text-white">Comparte tu enlace</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-medium">
          ...
          {/* Paso 3 */}
          <div className="space-y-4 text-center md:text-left relative group">
            <div className="text-[72px] font-black text-slate-900 group-hover:text-blue-600/35 transition-colors select-none leading-none">03</div>
            <h3 className="text-xl font-bold text-white">Recibe pedidos y acuerda el pago</h3>
            <p className="text-xs text-slate-400 leading-relaxed font-medium">
