...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden relative">
      ...
      <header className="w-full max-w-7xl mx-auto px-6 h-20 flex items-center justify-between border-b border-slate-800/40 sticky top-0 bg-slate-950/80 backdrop-blur-xl z-50">
        <div className="flex items-center gap-2.5">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-red-500 flex items-center justify-center text-white shadow-lg shadow-blue-600/30">
      ...
      {/* 2. HERO SECTION con efectos de luz Azul, Rojo y Blanco */}
      ...
      <section id="features" className="w-full bg-slate-950 py-24 lg:py-32 border-t border-b border-slate-900 relative">
        <div className="w-full max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            <span className="text-xs font-bold text-blue-500 uppercase tracking-widest block">Potencia tu negocio</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
            ...
            {/* Feature 1 */}
            <div className="p-6 bg-slate-900/50 border border-slate-800/80 hover:border-blue-500/40 rounded-3xl space-y-4 transition-all duration-300 shadow-md group">
            ...
            {/* Feature 2 */}
            <div className="p-6 bg-slate-900/50 border border-slate-800/80 hover:border-blue-500/40 rounded-3xl space-y-4 transition-all duration-300 shadow-md group">
              <div className="w-11 h-11 rounded-2xl bg-red-500/10 text-red-400 flex items-center justify-center group-hover:scale-110 transition-transform">
      ...
      <section id="steps" className="w-full py-24 lg:py-32 relative bg-slate-950/30">
        <div className="w-full max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto space-y-4 mb-20">
            <span className="text-xs font-bold text-blue-500 uppercase tracking-widest block">Flujo simple</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="space-y-4 text-center md:text-left relative group">
              <div className="text-[64px] font-black text-slate-900 group-hover:text-blue-600/35 transition-colors select-none leading-none">01</div>
            ...
            {/* Paso 2 */}
            <div className="space-y-4 text-center md:text-left relative group">
              <div className="text-[64px] font-black text-slate-900 group-hover:text-blue-600/35 transition-colors select-none leading-none">02</div>
            ...
            {/* Paso 3 */}
            <div className="space-y-4 text-center md:text-left relative group">
              <div className="text-[64px] font-black text-slate-900 group-hover:text-blue-600/35 transition-colors select-none leading-none">03</div>
      ...
      <section id="faq" className="w-full py-24 lg:py-32 relative bg-slate-950/50 border-t border-slate-900">
        <div className="w-full max-w-4xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto space-y-4 mb-16">
            <span className="text-xs font-bold text-blue-500 uppercase tracking-widest block">Preguntas frecuentes</span>
